...
export default function FailedPayment() {
  ...
  return (
    <div className="relative flex items-start p-4 sm:p-8 justify-center mx-auto mt-20 text-[#E90000]">
      <Image
        src="/images/red-background.png"
        alt="Background"
        width={800}
        height={600}
        className="absolute -top-5 "
      />
      <div className="text-center max-w-2xl w-[550px] flex flex-col items-center">
        {/* Success Icon */}
        <ErrorIcon />

        {/* Main Heading */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-4">
          عملية الدفع غير ناجحة، يرجى المحاولة مرة أخرى.{" "}
        </h1>

        {/* Descriptive Paragraph */}
        <p className="text-lg leading-relaxed mb-6">
          في حال تم سحب المبلغ من حسابك، سيتم إرجاع المبلغ المدفوع إلى حسابك
          خلال الـ 72 ساعة القادمة.
        </p>

        {/* Tracking Number */}
        <p className="text-sm font-medium mb-8">
          رقم تتبع الدفع: {trackingId}{" "}
        </p>

        {/* Buttons */}
        {/* The buttons are stacked vertically on small screens and side-by-side on larger screens */}
        <div className="flex flex-col sm:flex-row-reverse sm:justify-center gap-4 w-full mt-8">
